...
if("TRUE" STREQUAL "TRUE")
  set(hector_costmap_SOURCE_PREFIX /home/jov/tesi_ws/src/hector_navigation/hector_costmap)
  set(hector_costmap_DEVEL_PREFIX /home/jov/tesi_ws/devel)
  ...
  set(hector_costmap_INSTALL_PREFIX /home/jov/tesi_ws/install)
...
if(NOT "/home/jov/tesi_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_costmap' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jov/tesi_ws/src/hector_navigation/hector_costmap/${idir}'.  Ask the maintainer 'Stefan Kohlbrecher <kohlbrecher@sim.tu-darmstadt.de>' to fix it.")
    endif()
